...
const PromoBannerCard = ({ banner }) => {
    const { image, title, subtitle, btnText } = banner;
    return (
            ...
            <div className="shadow border m-2 rounded sm:mb-3">
                <div className="promo_card m-3 rounded overflow" style={{
                    ...
                    <div className="">
                        ...
                        <Link to="">
                            <button
                                className="py-2.5 hover:bg-secondCol text-small  hover:text-white px-6  bg-firstCol text-white rounded-lg">{btnText}</button>
                        </Link>
